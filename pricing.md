...
- Structure : un forfait mensuel de gestion, majoré d'une part du budget publicitaire confié — offre unique, les anciennes formules Growth et Performance ont été supprimées
...
- Structure : un forfait mensuel de gestion, majoré d'une part du budget publicitaire dépensé
...
## Agents IA — Sitaly Agents IA (sur mesure)
- Structure : déploiement sur mesure puis abonnement mensuel, chiffré sur devis
- Inclut : agents qui répondent aux demandes entrantes, qualifient, prennent les rendez-vous et relancent les devis
- Détail : https://sitaly.fr/agents-ia/

## Compléments
- Blog SEO : articles optimisés rédigés et mis en page chaque mois, en complément d'un forfait ou seuls
- Logo et identité visuelle, photos professionnelles, rédaction de contenus : à la demande, sur devis

## Pour qui
- PME et entreprises de services qui investissent déjà en acquisition : B2B, SaaS, e-commerce, immobilier, assurance, formation
- Professions libérales et de santé : avocats, experts-comptables, consultants, ostéopathes, kinésithérapeutes
- Artisans : plombiers, électriciens, couvreurs, façadiers, menuisiers, peintres, maçons
- TPE et indépendants qui veulent un premier site professionnel

## Contact
- Téléphone : +33 6 58 68 33 72
- Email : contact@sitaly.fr
- Site : https://sitaly.fr
