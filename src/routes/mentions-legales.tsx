...
export const Route = createFileRoute("/mentions-legales")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Mentions légales du site Sitaly conformément à la loi française.",
      },
      ...
      { property: "og:title", content: "Mentions légales — Sitaly" },
      {
        ...
        content:
          "Informations légales sur l'éditeur, l'hébergeur et la propriété intellectuelle du site Sitaly.",
      },
  ...
  return (
    <LegalLayout title="Mentions légales" updated="17 juin 2026">
      ...
      <p>
        ...
        <br />
        Siège social : Brétigny-Sur-Orge
        <br />
        ...
        <br />
        Directeur de la publication : Teddy VIDAL
        <br />
        E-mail : contact@sitaly.fr
        <br />
        Téléphone : 0658683372
      </p>
      ...
      <p>
        ...
        <br />
        <strong>GitHub, Inc.</strong> (GitHub Pages)
        <br />
      ...
      <p>
        ...
        icônes, sons, logiciels, mise en page, charte graphique) sont la propriété exclusive de
        Sitaly ou de ses partenaires et sont protégés par les lois françaises et internationales
        relatives à la propriété intellectuelle.
      </p>
      <p>
        Toute reproduction, représentation, modification, publication, adaptation, totale ou
        partielle, de tout ou partie des éléments du site, quel que soit le moyen ou le procédé
        utilisé, est interdite sans autorisation écrite préalable de Sitaly, sous peine de
        constituer une contrefaçon (articles L.335-2 et suivants du Code de la propriété
        intellectuelle).
      </p>
      ...
      <p>
        ...
        et sans préavis, le contenu. Toutefois, Sitaly ne peut garantir l'exactitude, la précision
        ou l'exhaustivité des informations mises à la disposition sur ce site.
      </p>
