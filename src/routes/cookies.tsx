  ...
  return (
    <LegalLayout title="Politique de gestion des cookies" updated="17 juin 2026">
      ...
      <p>
        ...
        <strong>Google Tag Manager</strong> (Google Ireland Limited), pour mesurer la
        fréquentation et comprendre quelles pages sont consultées. Ces traceurs ne sont activés
        qu'après votre consentement : tant que vous n'avez pas accepté, le mode Consentement de
        Google est réglé sur « refusé » et aucun cookie de mesure d'audience n'est déposé.
      </p>
      ...
      <h3>Cookies tiers</h3>
      <p>
        Aucun cookie publicitaire n'est utilisé sur le site. Certains contenus intégrés (aperçus
        de sites clients, module de prise de rendez-vous Calendly) peuvent déposer leurs propres
