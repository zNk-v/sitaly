...
export const METIER_PAGES = [
  {
    to: "/site-internet-plombier" as LinkProps["to"],
  ...
  {
    to: "/site-internet-electricien" as LinkProps["to"],
  ...
  {
    to: "/site-internet-couvreur" as LinkProps["to"],
  ...
  {
    to: "/site-internet-menuisier" as LinkProps["to"],
